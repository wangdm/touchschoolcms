            ...
            <div class="operationbar">
                <div class="operationleft col-sm-6">
                    <div class="input-group">
                      <span class="input-group-addon" id="inputHelpBlock"><strong>老师：</strong></span>
                      <input type="text" id="inputHelpBlock" class="form-control" placeholder="选择老师" readonly>
                      <span class="input-group-btn">
                        <button class="btn btn-default" type="button" data-toggle="modal" data-target="#ChooseTeacherDialog"><span class="glyphicon glyphicon-search"></span></button>
                      </span>
                    </div>
                </div>
...
<!-- 选择班级对话框 -->
<div class="modal fade" id="ChooseTeacherDialog" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="ChooseTeacherBtn">确定</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
$(function(){
    ...
    $("#ChooseTeacherBtn").on("click",function(){
